...
const EthereumIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12.3735 15.4298L17.9963 12.165L12.3735 9.65399V15.4298Z" fill="white" fillOpacity="0.2"/>
    <path d="M6.75 12.165L12.3735 15.4298V9.65399L6.75 12.165Z" fill="white" fillOpacity="0.602"/>
  </svg>
);
