...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Lien vers OpenRouteService pour calculer les distances -->
        <script src="https://cdn.jsdelivr.net/npm/openrouteservice-js@6.1.1/dist/openrouteservice-js.bundle.js"></script>
